"""
@time: 2020/7/30 17:06
@file: app.py
@desc: Git新拉取一个远程分支的练习项目
"""
...
#  程序实例需要知道对于每一个url请求启动那一部分代码，
#  所以保存了一个url和python函数的映射关系，处理url和函数之间关系的程序，称为路由
...
#  第三部分：启动服务器#  程序实例用run方法启动flask集成的开发web服务器
